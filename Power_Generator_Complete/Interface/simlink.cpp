...
int main()
{
	...
	while(1)
	{
		...
		*/
		printf("******** Data in SimLink ********\n");
		printf("Station 0 - Inputs to DCS: \nVRMS: %d; \tRMS: %d; \tFrequency: %d; \tRPM: %d \tFuel: %d \t\n", stations_data[0].analogIn[0], stations_data[0].analogIn[1], stations_data[0].analogIn[2], stations_data[0].analogIn[3], stations_data[0].analogIn[4]);
		printf("Oil: %d; \tTemperature: %d;\n\n", stations_data[0].analogIn[5], stations_data[0].analogIn[6]);
		printf("Station 0 - Outputs from DCS: \nSwitch Frequency: %d; \tOn/Off: %d; \tConnection: %d; \tvrms: %d; \tGain: %d\n\n\n\n", stations_data[0].digitalOut[0], stations_data[0].digitalOut[1], stations_data[0].digitalOut[2], stations_data[0].analogOut[0], stations_data[0].analogOut[1]);
