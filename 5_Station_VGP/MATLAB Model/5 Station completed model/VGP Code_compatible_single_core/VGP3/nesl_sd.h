...
#ifndef __nesl_sd_h__
#define __nesl_sd_h__
...
#define LOCAL_SIM_DATA_FUNCTION(_name, _type)                           \
    PMF_DEPLOY_STATIC _type *local_sim_data_##_name(const NeslSimulationData *sd)  \
    {                                                                   \
...
PMF_DEPLOY_STATIC NeslSimulationData *nesl_create_simulation_data()
{
    PmAllocator *a = pm_default_allocator();
    NeslSimulationData *sim_data = (NeslSimulationData*) pm_allocator_alloc(a, sizeof(NeslSimulationData), 1);
    NeslSimulationDataData *data = (NeslSimulationDataData*) pm_allocator_alloc(a, sizeof(NeslSimulationDataData), 1);
